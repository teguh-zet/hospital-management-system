<template>
  <nav class="navbar-nav bg-dark sidebar" style="min-height: 100vh; width: 250px; padding-top: 20px; display: flex; flex-direction: column;">
    <div class="nav flex-column" style="flex: 1;">
      <router-link to="/user/admin/dashboard" class="nav-link text-white" active-class="active">
        <i class="bi bi-speedometer2 me-2"></i>Dashboard
      </router-link>
      <router-link to="/user/admin/allEmployee" class="nav-link text-white" active-class="active">
        <i class="bi bi-people me-2"></i>All Employees
      </router-link>
      <router-link to="/user/admin/allPatient" class="nav-link text-white" active-class="active">
        <i class="bi bi-person-heart me-2"></i>All Patients
      </router-link>
      <router-link to="/user/admin/addEmp" class="nav-link text-white" active-class="active">
        <i class="bi bi-person-plus me-2"></i>Add Employee
      </router-link>
      <router-link to="/user/admin/rmEmp" class="nav-link text-white" active-class="active">
        <i class="bi bi-person-x me-2"></i>Remove Employee
      </router-link>
      <router-link to="/user/admin/resources" class="nav-link text-white" active-class="active">
        <i class="bi bi-box-seam me-2"></i>Resources
      </router-link>
      <router-link to="/user/admin/addResources" class="nav-link text-white" active-class="active">
