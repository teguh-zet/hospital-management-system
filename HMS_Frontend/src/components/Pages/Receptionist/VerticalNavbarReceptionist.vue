<template>
  <nav class="navbar-nav bg-dark sidebar" style="min-height: 100vh; width: 250px; padding-top: 20px; display: flex; flex-direction: column;">
    <div class="nav flex-column" style="flex: 1;">
      <router-link to="/user/receptionist/dashboard" class="nav-link text-white" active-class="active">
        <i class="bi bi-speedometer2 me-2"></i>Dashboard
      </router-link>
      <router-link to="/user/receptionist/appointmentList" class="nav-link text-white" active-class="active">
        <i class="bi bi-calendar-check me-2"></i>Appointment List
      </router-link>
      <router-link to="/user/receptionist/admitList" class="nav-link text-white" active-class="active">
        <i class="bi bi-hospital me-2"></i>Admit Patient
      </router-link>
      <router-link to="/user/receptionist/discharge" class="nav-link text-white" active-class="active">
        <i class="bi bi-box-arrow-right me-2"></i>Discharge Patient
      </router-link>
      <router-link to="/user/receptionist/resource" class="nav-link text-white" active-class="active">
...
export default {
  name: 'VerticalNavbarReceptionist',
  setup() {
