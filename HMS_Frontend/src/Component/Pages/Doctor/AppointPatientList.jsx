...
function AppointPatientList() {
  ...
  // };
const handleFormSubmit = () => {
    // Hapus atau abaikan debugger jika tidak diperlukan
    // debugger;

    // Validasi di frontend sebelum mengirim ke server
    // if (health.prescriptionInstruction && health.prescriptionInstruction.length < 50) {
    //     toast.error("Prescription Instruction must be at least 50 characters long.");
